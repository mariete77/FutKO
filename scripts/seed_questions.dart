// FutKO — Seed Script para Firestore
// Ejecutar con: dart run scripts/seed_questions.dart
//
// Requiere: firebase_core, cloud_firestore, firebase_auth
//
// Antes de ejecutar, asegurate de tener firebase_options.dart generado
// y Firestore habilitado en el proyecto futko-battle.
...
List<Map<String, dynamic>> _playerQuestions() {
  return [
    ...
    },
    {
      ...
      'type': 'player',
      'difficulty': 'hard',
      'questionText': '¿Qué jugador ganó el Balón de Oro en 1995, el último antes de la era del decreto Bosman?',
